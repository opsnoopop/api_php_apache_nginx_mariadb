# Nginx PHP-Apache API with MariaDB

A simple Nginx PHP-Apache API application and MariaDB, containerized with Docker.
...
```bash
git clone https://github.com/opsnoopop/api_php_apache_nginx_mariadb.git
```

### 2. Navigate to Project Directory
```bash
cd api_php_apache_nginx_mariadb
```
